...
namespace autoc
{
    public partial class _02Accessoire : Form
    {
        string Table = "Accessoire";
        public _02Accessoire()
        {
            InitializeComponent();
        }
        ...
        private void _02Accessoire_Load(object sender, EventArgs e)
        {
        ...
        private void _02Accessoire_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (Program.filepath != "")
            {
        ...
        {
            choix();
            SqlCeCommand cmd = new SqlCeCommand("select modeleAc, nomAc, prixHtAc, tvaAc, montantTvaAc, pclientTtcAc, prixVenteAc from " + Table, Services.con);
        ...
        //Vidange de la table Accessoire
        public void vidange()
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               if(etat==2 || !exl)
                {
                    Stream f;
                    openFileDialog1.Filter = "Acc file (*.acc)|*.acc";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(etat==2 || !exl)
                {
                    ...
                    {
                        Stream f;
                        saveFileDialog1.Filter = "Acc file (*.acc)|*.acc";
                        saveFileDialog1.RestoreDirectory = true;
